<form action="../Controlador/Cmovimiento_tecnico.php" method="post">
	<input type="hidden" hidden value="_token" name="_token">
	<input type="number" name="id_movimiento" id="id_movimiento" value="0" placeholder="id_movimiento"><br>
	...
	<a href="allviewMovimiento_tecnico.php">Ver todos</a>
